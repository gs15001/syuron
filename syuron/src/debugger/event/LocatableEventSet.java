...
public abstract class LocatableEventSet extends AbstractEventSet {
	...
	/**
	 * Returns the {@link Location} of this mirror. Depending on context and on
	 * available debug information, this location will have varying precision.
	 *
	 ...
	 *
	 * @return a {@link ThreadReference} which mirrors the event's thread in the
	 *         target VM.
	 */

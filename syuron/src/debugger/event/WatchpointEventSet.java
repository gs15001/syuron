...
public abstract class WatchpointEventSet extends LocatableEventSet {
	...
	/**
	 * Returns the object whose field is about to be accessed/modified. Return
	 * null is the access is to a static field.
	 *
	 * @return a {@link ObjectReference} which mirrors the event's object in the
	 *         target VM.
	 */

...
public class Utils {
	...
	// ### UNUSED.
	/************************
	 * private String typedName(Method method) { // TO DO: Use
	 * method.signature() instead of method.arguments() so that // we get
	 * sensible results for classes without debugging info StringBuffer buf =
	 * new StringBuffer(); buf.append(method.name()); buf.append("("); Iterator
	 * it = method.arguments().iterator(); while (it.hasNext()) {
	 * buf.append(((LocalVariable)it.next()).typeName()); if (it.hasNext()) {

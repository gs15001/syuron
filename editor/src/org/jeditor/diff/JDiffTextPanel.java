...
public class JDiffTextPanel extends JComponent {
        ...
        protected void analyze_hunk(Diff.change hunk) {
            ...
            for (next = hunk; next != null; next = next.link) {
                ...
                for (i = next.line0; i <= l0 && ! nontrivial; i++)
                    if (!ignore.execute(file0[i])) nontrivial = true;
                for (i = next.line1; i <= l1 && ! nontrivial; i++)
                    if (!ignore.execute(file1[i])) nontrivial = true;
            }
    ...
    public static void main(String[] argv) throws IOException {
        ...
        String[] b = {"aaaTOTaaa","aaaTATAaaa","aaaTATA TIaaa","aaaTATAaaa",
                        "aaaTUTUaaa","aaaTPPaaa","aaaTRRaaa","aaaTRIaaa"};

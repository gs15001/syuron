...
package org.jeditor.scripts.base;
 ...
 * line is tokenized. Therefore, the return value of <code>markTokens</code> should only be used for immediate painting.
 * Notably, it cannot be
 * cached.
 *
 * @author Slava Pestov
 * @version 0.2
...
public abstract class TokenMarker {
	 ...
	 * required to pass all lines in the document to the <code>markTokens()</code> method (in turn).
	 * <p>
	 *
	 ...
	 * the document. This inserts a gap in the <code>lineInfo</code> array.
	 * 
	 * @param index
	 ...
	 * the document. This removes the lines in question from the <code>lineInfo</code> array.
	 * 
	 * @param index
	 *            The first line number
	 * @param lines
	 ...
	 * shrunk automatically by the <code>insertLines()</code> and <code>deleteLines()</code> methods.
	 */
	 ...
	 * a lineInfo array; an initial call to <code>insertLines()</code> does that.
	 */

...
public class Navi_a5 extends AbstractNaviPane {
	...
	public Navi_a5(NaviManager mgr) {
		...
		questionLabel.setText("<html>現在着目している範囲にある条件文(if)や繰り返し文(while,for)を<br>"
				+ "選択してください。<br>"
				+ "複数存在している場合は、外側(コードの上のほう）から<br>"
				+ "選択してください。</html>");
		descriptLabel.setText("<html>誤っている変数があるにもかかわらず、代入している処理が<br>"
				+ "ない場合、誤る原因は条件文や繰り返し文にあると考えられます。<br>"
				+ "着目している範囲にある条件文や繰り返し文に誤りがないか<br>"
				+ "確認します。</html>");
		//@formatter:on

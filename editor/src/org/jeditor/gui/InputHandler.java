 ...
 * Copyright (C) 2012, 2014 Herve Girod
 *
...
public abstract class InputHandler extends KeyAdapter {
   ...
   public static final ActionListener SHIFT_LEFT = new shift_left();
   public static final ActionListener SHIFT_RIGHT = new shift_right();
    ...
    * @param evt The event
    */
   public static JEditor getTextArea(EventObject evt) {
      if (evt != null) {
   ...
   public static class backspace implements ActionListener {
      public void actionPerformed(ActionEvent evt) {
         JEditor textArea = getTextArea(evt);
   ...
   public static class backspace_word implements ActionListener {
      public void actionPerformed(ActionEvent evt) {
         ...
         try {
            textArea.getSyntaxDocument().remove(
                caret + lineStart,
   ...
   public static class delete_word implements ActionListener {
      public void actionPerformed(ActionEvent evt) {
         ...
         try {
            textArea.getSyntaxDocument().remove(start,
   ...
   public static class select_all implements ActionListener {
      ...
      public void actionPerformed(ActionEvent evt) {
         ...
         // we don't change the caret position, because we would unselect all the previously
         // selected area
      }
   }
   ...
   public static class undo implements ActionListener {
      public void actionPerformed(ActionEvent evt) {
         JEditor textArea = getTextArea(evt);
         UndoManager manager = textArea.getSyntaxDocument().getUndoManager();
         if (manager.canUndo()) {
            manager.undo();
         }
      }
   ...
   public static class shift_left implements ActionListener {
      public void actionPerformed(ActionEvent evt) {
         JEditor textArea = getTextArea(evt);
         ...
         char[] chars = new char[textArea.getTabSize()];
         Arrays.fill(chars, ' ');
      }
   }

   public static class shift_right implements ActionListener {
      public void actionPerformed(ActionEvent evt) {
         JEditor textArea = getTextArea(evt);
         ...
         textArea.overwriteSetSelectedText(String.valueOf(chars));
      }
   }

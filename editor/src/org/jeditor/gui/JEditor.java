...
public class JEditor extends JComponent {
    ...
    * <code>JEditTextArea</code> instances unless they
    ...
    * JComponent.
    * <p>
    * This is not now the case as a new UI manager class (like BasicTextUI) must be created,
    * and also a new EditorKit...
    *
   ...
   /**
    * Updates the
    * <code>InputMap</code>s in response to a
    ...
    * actions. Setting to
    * <code>null</code> effectively disables
    * keyboard input.
      ...
      if (keymap.isLocallyDefined(key)) {
         ...
         if (action != null) {
            ActionEvent evt = new ActionEvent(
                event.getSource(), ActionEvent.ACTION_PERFORMED, String.valueOf(event.getKeyChar()));
    ...
    * Sets the entire text of this text area.
    * <p>
    * the Vector must contain the (String) lines of the text</p>
    */
   ...
   /**
    * Similar to
    * <code>setSelectedText()</code>, but overstrikes the
   ...
   static class DefaultKeymap implements Keymap {
      ...
      public KeyStroke[] getKeyStrokesForAction(Action a) {
         ...
         for (Enumeration _enum = bindings.keys();
